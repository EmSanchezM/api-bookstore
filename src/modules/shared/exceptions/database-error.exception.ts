...
/**
 * Defines an HTTP exception for *Database Error* type errors.
 *
 * The HTTP response status code is 500.
 *
 * @publicApi
 */
export class DatabaseErrorException extends HttpException {
   ...
   */
  constructor(objectOrError?: any, descriptionOrOptions: string | HttpExceptionOptions = 'Database Error') {
